 ...
 * @property {boolean}           [renameScopedVBindCSS=false]     This renames `style="--abcd1234-color: #F00;"` to `style="--scoped-color: #F00;"`. This comes from using `background: v-bind(color);` in your scoped styles.
