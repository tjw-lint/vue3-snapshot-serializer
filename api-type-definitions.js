 ...
 * @property {'html'|'xhtml'|'closingTag'} [voidElements='xhtml']  Determines how void elements are closed. Accepts 'html' for `<input>`, 'xhtml' for `<input />`, and 'closingTag' for `<input></input>`.
 */

/**
 * @typedef  {object}                      SNAPSHOT_SETTINGS
 ...
 * @property {'none'|'diffable'|FORMATTER} [formatter='diffable']        Function to use for formatting the markup output. See examples below. Accepts 'none', 'diffable', or a function. If using a custom function it will be handed a string of markup and must return a string (not a promise).
